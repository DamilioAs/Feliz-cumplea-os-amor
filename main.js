document.addEventListener("DOMContentLoaded", () => {
  ...
  const canciones = ["cancion1.mp3", "cancion2.mp3", "cancion3.mp3", "cancion4.mp3", "cancion5.mp3", "cancion6.mp3", "cancion7.mp3", "cancion8.mp3"];
  let indice = 0;
  ...
  function cargarCancion() {
    audio.src = `../musica/${canciones[indice]}`;
  }
